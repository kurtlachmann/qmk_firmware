...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NAV] = LAYOUT_ortho_5x15(
    ...
    _______, DE_LESS, DE_MORE, DE_LCBR, DE_RCBR, XXXXXXX, KC_CAPS, KC_PSCR, KC_INS,  XXXXXXX, XXXXXXX, KC_UP,   CTLPGUP, CTLPGDN, _______,
    _______, DE_LBRC, DE_RBRC, DE_LPRN, DE_RPRN, XXXXXXX, _______, KC_NLCK, _______, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, KC_END,  _______,
    _______, DE_PIPE, DE_BSLS, DE_AMPR, DE_TILD, XXXXXXX, _______, _______, _______, XXXXXXX, KC_HOME, KC_BSPC, KC_DEL,  XXXXXXX, _______,
  ...
  [_ADJUST] = LAYOUT_ortho_5x15(
    ...
    XXXXXXX, XXXXXXX, KC_WH_L, KC_WH_D, KC_WH_R, XXXXXXX, _______, _______, _______, XXXXXXX, KC_MS_L, KC_MS_D, KC_MS_R, XXXXXXX,  _______,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______, _______, _______, XXXXXXX, KC_BTN1, KC_BTN2, KC_BTN3, XXXXXXX, _______,
    XXXXXXX, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
  ),
  ...
  [_FN] = LAYOUT_ortho_5x15(
    GAMING,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
    KC_VOLU, RGB_VAI, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_CAPS, KC_PSCR, KC_INS,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
    KC_VOLD, RGB_VAD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
    KC_MUTE, RGB_TOG, RGB_MOD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
